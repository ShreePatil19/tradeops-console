...
| PRs merged in v0.3 polish phase | 13 (#66 to #73 plus the agent-routes, eval-scorer, env-sync, PDF-fixture, and quota-chip passes) |
| Unit tests | 270 / 270 green across 25 test files |
