...
| PRs merged in v0.3 polish phase | 16 (#66 to #73 plus the agent-routes, eval-scorer, env-sync, PDF-fixture, quota-chip, Axiom-sink, cache-extend, and PDF-live-wire passes) |
| Unit tests | 307 / 307 green across 27 test files |
