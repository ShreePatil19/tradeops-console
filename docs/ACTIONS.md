...
| PRs merged in v0.3 polish phase | 15 (#66 to #73 plus the agent-routes, eval-scorer, env-sync, PDF-fixture, quota-chip, Axiom-sink, and cache-extend passes) |
| Unit tests | 296 / 296 green across 26 test files |
